...
# ----------------------------------------------------------------------
# Makefile generated from "Imake.tmpl" and </tmp/IIf.aUGUz5>
...
# operating system:  Linux 2.6.18-92.1.1.el5 x86_64 [ELF] (2.6.18)
# libc:	(6.5.0)
# binutils:	(217)
...
LOCAL_LIBRARIES = $(XAWLIB) $(XMULIB) $(XTOOLLIB) $(XLIB) 	          $(XEXTLIB) $(MATHLIB)
